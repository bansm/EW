...
namespace EW.Utility.AnsyncHelp
{
    ...
    public class ManagedThreadPool
    {
        ...
        /// <summary>工作线程池.</summary>
        /// <param name="callback">
        /// A WaitCallback representing the delegate to invoke when the thread in the 一个 WaitCallback 一个委托类
        /// thread pool picks up the work item.
        /// </param>
        /// <param name="state">
        /// 参数对象装换城object The object that is passed to the delegate when serviced from the thread pool.
        /// </param>
        ...
        private class WaitingCallback
        {
            ...
            /// <param name="callback">Callback delegate for the callback.调用的方法名称</param>
            /// <param name="state">State with which to call the callback delegate. 调用的数据</param>
